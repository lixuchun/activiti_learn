...
public class GroupTaskTest2 {
	...
	/**
	 * 启动流程实例 程序点击申请流程 ,启动流程实例时候 添加办理人参数
	 */
	@Test
	public void startProcessInstance() {
		...
		ProcessInstance processInstance = processEngine.getRuntimeService()// 与正在执行的流程实例和执行对象相关的 service 默认最新版本
			.startProcessInstanceByKey(processKey, variables);// 启动流程通过流程定义key 对应helloworld.bpmn文件中id对应值
