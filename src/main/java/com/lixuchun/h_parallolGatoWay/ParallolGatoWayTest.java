package com.lixuchun.h_parallolGatoWay;
...
public class ParallolGatoWayTest {
	...
	public void deployProcessDefinitition_InputStream() {
		InputStream inputStreamBpmn = this.getClass().getResourceAsStream("parallolGatoWay.bpmn");
		InputStream inputStreamPng = this.getClass().getResourceAsStream("parallolGatoWay.png");
		
		Deployment deployment = processEngine.getRepositoryService() // 流程部署相关对象
				.createDeployment() // 创建一个部署对象
				.name("并行网关")
				.addInputStream("parallolGatoWay.bpmn", inputStreamBpmn)
				.addInputStream("parallolGatoWay.png", inputStreamPng)
				.deploy(); // 返回一个部署对象
	...
	public void startProcessInstance() {
		String processKey = "parallolGatoWay";
